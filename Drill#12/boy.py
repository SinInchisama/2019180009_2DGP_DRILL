...
class Boy:
    ...
    def Fire_ball(self):
        pass
        # # play_state.balls.append(Ball.Ball(self.x,self.y-20,self.face_dir))
        # #play_state.balls = Ball.Ball(self.x,self.y-20,self.face_dir)
        # # 발사 시점에 볼 생성
        # ball = Ball.Ball(self.x,self.y-20,self.face_dir * 2)
        # game_world.add_Object(ball,1 )
        # print('Fire ball shoot')
